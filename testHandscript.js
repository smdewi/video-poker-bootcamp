...
const straightFlushHand = [
  {name: '3', suit: 'hearts', suitSymbol: '♥️', rank: 3, color: 'red',},
  {name: '2', suit: 'hearts', suitSymbol: '♥️', rank: 2, color: 'red',},
  {name: '5', suit: 'hearts', suitSymbol: '♥️', rank: 5, color: 'red',},
  {name: '4', suit: 'hearts', suitSymbol: '♥️', rank: 4, color: 'red',},
  {name: 'A', suit: 'hearts', suitSymbol: '♥️', rank: 1, color: 'red',},
];

const fourOfKindHand = [
  {name: '6', suit: 'hearts', suitSymbol: '♥️', rank: 6, color: 'red',},
...
const flushHand = [
  {name: '6', suit: 'hearts', suitSymbol: '♥️', rank: 6, color: 'red',},
  {name: '2', suit: 'hearts', suitSymbol: '♥️', rank: 2, color: 'red',},
  {name: '8', suit: 'hearts', suitSymbol: '♥️', rank: 8, color: 'red',},
  {name: 'Q', suit: 'hearts', suitSymbol: '♥️', rank: 12, color: 'red',},
  {name: 'A', suit: 'hearts', suitSymbol: '♥️', rank: 1, color: 'red',},
];
